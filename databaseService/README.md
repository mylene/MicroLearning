...
# Copied from: Helidon Quickstart MP Example

This example implements a simple Hello World REST service using MicroProfile

## My changes:
1. I used Java 12 (Zulu)
2. I modularised my module

## My notes:
1. I didn't test Docker or Kubernetes (yet)
2. The PUT test doesn't work (yet)

## Prerequisites

1. Maven 3.5 or newer
2. Java SE 9 or newer
